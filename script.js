const CONFIG = {
    mainQuestion: "Will you be my Valentine?Si KONTOL",
    subQuestion: "Please say ANJING ",
    yesButton: "YES KONTOL",
    noButton: "NO KANJUT",
    noEscapeTexts: ["Eits, TEU BISA GEUS DI HALANG KU AING JENG KONTOL AING😝", "Hehe, HARESE NYA ENGKE KEDENG ANJING IYE ENDEK DI ANJING😜", "Yaudah deh, aku anggap ANJING AJA YA! 💕"],
    confirmTitle: "YEAAAY! Kamu Beneran Mau JADI ANJING 💗",
    confirmText: "Mulai dari sekarang kamu resmi jadi… MONYET",
    badgeText: "My KANJUT",
    nextButton: "Kanjut ",
    repeatButton: "Ulangi pertanyaan",
    flowerTitle: "Ini kado spesial buat KANJUT LAIN BOGA SIA HAYANGEN SIA",
    takeBouquetButton: "Terima hadiahnya KANJUT",
    bouquetMessage: "Yeay! Udah jadi KANJUT",
    nextFlowerButton: "Next ",
    collageTitle: "My KANJUT",
    collageSubtitle: "Sejak kamu hadir, hal HAL KANJUT DAN KONTOL DAN ANJING DAN MONYET SEDANG PACARAN. 💕",
    nextCollageButton: "Satu halaman lagi… ATUH SI KANJUT MAH",
    finalTitle: "Happy Valentine, My KANJUT 💞",
    finalMessage: `Makasih ya sudah hadir dan bikin hariku selalu terasa cukup. Kamu KANJUT JU KAISEN adalah alasan kenapa senyum itu mudah muncul. Semoga hari harimu selalu penuh kehangatan dan kebahagiaan. Aku selalu ada untukmu. Happy SI KANJUT💕`,
    restartButton: "Restart ",
    copyButton: "Copy Message ",
    copySuccess: "Pesan berhasil DIENTOT"
};
